<template>
   <div class="h">
        <h4 class="text-center mt-20">
         <small>
         <button class="btn btn-success" v-on:click="navigate()"> View All Registered Students </button>
         </small>
        </h4>
        ...
        <div class="col-md-12 form-wrapper">
          ...
          <form id="create-post-form" @submit.prevent="editCustomer">
            ...
            <div class="form-group col-md-12">
              ...
              <div class="form-group col-md-12">
                  <label for="description"> Course & Year Level </label>
                  <input type="text" id="description" v-model="customer.description" name="description" class="form-control" placeholder="Enter Course & Year Level">
              </div>
